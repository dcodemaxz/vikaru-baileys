...
export type SocketConfig = {
    ...
    /** should vikaru use the mobile api instead of the multi device api
    ...
    */
    ...
    /** Should Vikaru ask the phone for full history, will be received async */
    syncFullHistory: boolean;
    /** Should vikaru fire init queries automatically, default true */
