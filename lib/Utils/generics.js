...
const baileys_version_json_1 = require("../Defaults/vikaru-version.json");
...
/**
 * Fungsi utama untuk fetch versi terbaru Vikaru (WhiskeySockets/Baileys).
 * Menggunakan NPM registry untuk real-time update.
 * Fallback ke vikaru-version.json kalau gagal.
 */
const fetchLatestVikaruVersion = async (options = {}) => {
    try {
...
exports.fetchLatestVikaruVersion = fetchLatestVikaruVersion;

/**
 * Fungsi untuk fetch versi terbaru Baileys (original).
 * Menggunakan NPM registry untuk real-time update.
 * Fallback ke vikaru-version.json kalau gagal (bisa diganti kalau punya file terpisah).
 */
