...
const baileys_version_json_1 = require("../Defaults/vikaru-baileys-version.json");
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://unpkg.com/wileys@0.0.1/lib/Defaults/vikaru-baileys-version.json';
    try {
