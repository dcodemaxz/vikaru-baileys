...
import type { VikaruEventEmitter, Chat, ConnectionState, Contact, GroupMetadata, PresenceData, WAMessage, WAMessageCursor, WAMessageKey } from '../Types';
...
export type VikaruInMemoryStoreConfig = {
    chatKey?: Comparable<Chat, string>;
    labelAssociationKey?: Comparable<LabelAssociation, string>;
    logger?: ILogger;
    socket?: WASocket;
};
declare const _default: (config: VikaruInMemoryStoreConfig) => {
    ...
    bind: (ev: VikaruEventEmitter) => void;
